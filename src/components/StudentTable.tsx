...
import { dueBadge, formatCurrency, getReminderInfo, outstandingAmount } from "@/lib/utils";
            ...
            {students.map((s) => {
              ...
              return (
                <tr key={s.id} className="border-t border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    {(() => {
                      const owed = outstandingAmount(s.nextDueDate, s.monthlyFee);
                      return owed > 0 ? (
                        <span className="font-medium text-red-600">{formatCurrency(owed)}</span>
                      ) : (
